...
/**
 * Idaho Wrestling Tournament Scraper
 * Scrapes all Idaho state wrestling tournaments for multiple years and divisions
 */
...
const tournaments = [
  // 2025 Tournaments
  { state: 'ID', year: '2025', division: '3A-6A', tournamentId: '853919132' },

  
  // 2024 Tournaments
  { state: 'ID', year: '2024', division: '2A-5A', tournamentId: '770650132' },

  
  // 2023 Tournaments
  { state: 'ID', year: '2023', division: '2A-5A', tournamentId: '679060132' },

  
  // 2022 Tournaments
  { state: 'ID', year: '2022', division: '2A-5A', tournamentId: '632197132' },
...
async function scrapeAllTournaments() {
  console.log('🚀 Starting Idaho Wrestling Tournament Scraping...');
  ...
  console.log('\n🎉 Idaho tournament scraping completed!');
  return results;
}
 ...
 */
async function main() {
  console.log('🏆 Idaho Wrestling Tournament Scraper');
  console.log('=====================================\n');
  ...
  console.log(`\n📋 About to scrape ${tournaments.length} Idaho wrestling tournaments:`);
