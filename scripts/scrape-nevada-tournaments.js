...
/**
 * Nevada Wrestling Tournament Scraper
 * Scrapes all Nevada state wrestling tournaments for multiple years and divisions
 */
...
const tournaments = [
  // 2025 Tournaments
  { state: 'NV', year: '2025', division: '2A-5A', tournamentId: '854604132' },

  
  // 2024 Tournaments
  { state: 'NV', year: '2024', division: '2A-5A', tournamentId: '831108132' },

  
  // 2023 Tournaments
  { state: 'NV', year: '2023', division: '2A', tournamentId: '683358132' },
  { state: 'NV', year: '2023', division: '3A', tournamentId: '683359132' },
  { state: 'NV', year: '2023', division: '4A', tournamentId: '683360132' },
  { state: 'NV', year: '2023', division: '5A', tournamentId: '683362132' },

  // 2022 Tournaments
  { state: 'NV', year: '2022', division: '3A', tournamentId: '653387132' },
...
async function scrapeAllTournaments() {
  console.log('🚀 Starting Nevada Wrestling Tournament Scraping...');
  ...
  console.log('\n🎉 Nevada tournament scraping completed!');
  return results;
}
 ...
 */
async function main() {
  console.log('🏆 Nevada Wrestling Tournament Scraper');
  console.log('=====================================\n');
  ...
  console.log(`\n📋 About to scrape ${tournaments.length} Nevada wrestling tournaments:`);
