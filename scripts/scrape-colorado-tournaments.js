...
/**
 * Colorado Wrestling Tournament Scraper
 * Scrapes all Colorado state wrestling tournaments for multiple years and divisions
 */
...
const tournaments = [
  // 2025 Tournaments
  { state: 'CO', year: '2025', division: '3A-6A', tournamentId: '853702132' },

  
  // 2024 Tournaments
  { state: 'CO', year: '2024', division: '2A-5A', tournamentId: '770585132' },

  
  // 2023 Tournaments
  { state: 'CO', year: '2023', division: '2A-5A', tournamentId: '683382132' },

  
  // 2022 Tournaments
  { state: 'CO', year: '2022', division: '2A-5A', tournamentId: '631951132' },
...
async function scrapeAllTournaments() {
  console.log('🚀 Starting Colorado Wrestling Tournament Scraping...');
  ...
  console.log('\n🎉 Colorado tournament scraping completed!');
  return results;
}
 ...
 */
async function main() {
  console.log('🏆 Colorado Wrestling Tournament Scraper');
  console.log('=====================================\n');
  ...
  console.log(`\n📋 About to scrape ${tournaments.length} Colorado wrestling tournaments:`);
