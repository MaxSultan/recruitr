...
/**
 * Utah Wrestling Tournament Scraper
 * Scrapes all Utah state wrestling tournaments for multiple years and divisions
 */
...
const tournaments = [
  // 2025 Tournaments
  { state: 'UT', year: '2025', division: '1A', tournamentId: '854864132' },
  { state: 'UT', year: '2025', division: '2A', tournamentId: '854864132' },
  { state: 'UT', year: '2025', division: '3A', tournamentId: '854865132' },
  { state: 'UT', year: '2025', division: '4A', tournamentId: '854866132' },
  { state: 'UT', year: '2025', division: '5A', tournamentId: '854867132' },
  { state: 'UT', year: '2025', division: '6A', tournamentId: '854868132' },
  
  // 2024 Tournaments
  { state: 'UT', year: '2024', division: '1A', tournamentId: '771504132' },
  { state: 'UT', year: '2024', division: '2A', tournamentId: '771504132' },
  { state: 'UT', year: '2024', division: '3A', tournamentId: '771505132' },
  { state: 'UT', year: '2024', division: '4A', tournamentId: '771506132' },
  { state: 'UT', year: '2024', division: '5A', tournamentId: '771507132' },
  { state: 'UT', year: '2024', division: '6A', tournamentId: '771508132' },
  
  // 2023 Tournaments
  { state: 'UT', year: '2023', division: '1A', tournamentId: '678783132' },
  { state: 'UT', year: '2023', division: '2A', tournamentId: '678783132' },
  { state: 'UT', year: '2023', division: '3A', tournamentId: '678784132' },
  { state: 'UT', year: '2023', division: '4A', tournamentId: '678786132' },
  { state: 'UT', year: '2023', division: '5A', tournamentId: '678787132' },
  { state: 'UT', year: '2023', division: '6A', tournamentId: '678789132' },
  
  // 2022 Tournaments
  { state: 'UT', year: '2022', division: '1A', tournamentId: '633011132' },
  { state: 'UT', year: '2022', division: '2A', tournamentId: '633011132' },
  { state: 'UT', year: '2022', division: '3A', tournamentId: '633012132' },
  { state: 'UT', year: '2022', division: '4A', tournamentId: '633013132' },
  { state: 'UT', year: '2022', division: '5A', tournamentId: '633014132' },
  { state: 'UT', year: '2022', division: '6A', tournamentId: '655098132' }
];
...
async function scrapeAllTournaments() {
  console.log('🚀 Starting Utah Wrestling Tournament Scraping...');
  ...
  console.log('\n🎉 Utah tournament scraping completed!');
  return results;
}
 ...
 */
async function main() {
  console.log('🏆 Utah Wrestling Tournament Scraper');
  console.log('=====================================\n');
  ...
  console.log(`\n📋 About to scrape ${tournaments.length} Utah wrestling tournaments:`);
